...
Extra spaces are accidentally entered when working with survey data, and problems can arise when evaluating such data because of extra spaces. The function str_rm_whitespace_df() eliminates your data frame unnecessary leading, trailing, or other whitespaces.
